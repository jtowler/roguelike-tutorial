...
class MessageLog:
    ...
    def add_message(self, text: str, fg: Tuple[int, int, int] = colour.white, *, stack: bool = True) -> None:
        """
        Add a message to this log.

        `text` is the message text `fg` is the text colour
        If `stack` is true then the message can stack with the previous message.
        """
    ...
    def wrap(string: str, width: int) -> Iterable[str]:
        """Return a wrapped string message"""
